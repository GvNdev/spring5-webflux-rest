...
class CategoryControllerTest {
    ...
    void update() {
        ...
        Mono<Category> updatedCategoryMono = Mono.just(Category.builder().description("Some Cat").build());
    ...
    void patch() {
        ...
        Mono<Category> patchedCategoryMono = Mono.just(Category.builder().description("New Description").build());

        webTestClient.patch().uri("/api/v1/categories/someid")
                .body(patchedCategoryMono, Category.class)
                .exchange()
                .expectStatus()
                .isOk();
    ...
    void patchNoChanges() {
        ...
        Mono<Category> patchedCategoryMono = Mono.just(Category.builder().build());
